...
async function getUserProfile(uid) {
    ...
    /* ==================================================
       ...
       NÃO ALTERAR A LÓGICA DO ADMINISTRADOR.
    ================================================== */
    ...
    /* ==================================================
       ...
       IMPORTANTE:
       COMPRADORES E REVENDEDORES ESTÃO NA TABELA
       "users".
    ================================================== */
...
function buildSession(
    ...
    /* ==================================================
       UID DO ADMINISTRADOR TEM PRIORIDADE
    ================================================== */
...
async function processAuthenticatedUser(
    ...
    try {
        ...
        if (!profile) {
            ...
            console.warn(
                "AV Market Auth: utilizador autenticado sem perfil na tabela users:",
                user.id
            );
        ...
        console.error(
            "AV Market Auth: erro ao carregar perfil da tabela users:",
            error
        );
