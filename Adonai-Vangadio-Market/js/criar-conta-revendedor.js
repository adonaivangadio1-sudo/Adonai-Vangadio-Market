    ...
    form.addEventListener(
        ...
        async function(event) {
            ...
            try {
                ...
                console.log(
                    "AV Market — revendedor criado no Auth:",
                    createdUser.id
                );
                ...
                if (profileError) {
                    ...
                    console.error(
                        "AV Market — erro ao criar perfil do revendedor na tabela users:",
                        profileError
                    );
                ...
                console.log(
                    "AV Market — perfil do revendedor criado:",
                    createdProfile
                );
