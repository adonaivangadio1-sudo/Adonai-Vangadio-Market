...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function smartLogout(event) {
        ...
        Object.keys(localStorage).forEach(key => {
            ...
            if (
                key.startsWith("avMarketCart_") ||
                key.startsWith("checkoutSummary_") ||
    ...
    /* =========================================
       BOTÃO CRIAR CONTA (RODAPÉ)
    ========================================= */

    const createAccountButton = document.querySelector(
        "#createAccountButton, .create-account-button, [data-create-account]"
    );
...
/* ============================================================
   AV MARKET — PESQUISA POR FOTOGRAFIA + SUPABASE STORAGE
...
(() => {
    ...
    function showImageSearchMessage(
        message,
        type = "info"
    ) {
    ...
    /* ========================================================
       GERAR NOME ÚNICO PARA A FOTOGRAFIA
    ======================================================== */
    ...
    function validateImage(file) {
        ...
        if (file.size > maxSize) {
            ...
            return {
                valid: false,
                message:
                    "A fotografia é demasiado grande. O limite é 10 MB."
            };
    ...
    async function getAuthenticatedUser(
        ...
        if (error) {
            ...
            console.warn(
                "AV Market — erro ao verificar utilizador:",
                error
            );
    ...
    async function uploadSearchImage(file) {
        ...
        if (!user) {
            ...
            showImageSearchMessage(
                "Inicie sessão para pesquisar produtos por fotografia.",
                "error"
            );
        ...
        try {
             ...
             * para a próxima etapa da pesquisa visual.
             */

            sessionStorage.setItem(
                "av_market_image_search",
                JSON.stringify(result)
            );


            showImageSearchMessage(
                "Fotografia enviada com sucesso. A preparar a pesquisa...",
                "success"
            );
            ...
            console.error(
                "AV Market — erro inesperado:",
                error
            );


            showImageSearchMessage(
                "Ocorreu um erro ao enviar a fotografia.",
                "error"
            );
    ...
    async function processImageSearch(file) {
        ...
        imageSearchButton.style.opacity =
            "0.6";
        ...
        try {
            ...
            /*
             * Aqui está o ponto de ligação com a
             * futura pesquisa visual.
             *
             * O URL da fotografia fica disponível
             * em:
             *
             * sessionStorage:
             * av_market_image_search
             ...
             *
             * Outros ficheiros JS podem escutar:
             *
             * document.addEventListener(
             *     "av:image-search-ready",
             *     event => {
            ...
            /*
             * Se existir um sistema de resultados
             * da pesquisa, podemos notificá-lo.
             */
    ...
    /* ========================================================
       SUPORTE A CÂMERA DO TELEMÓVEL
       ======================================================== */

    imageSearchInput.setAttribute(
        "capture",
        "environment"
    );
    ...
    /* ========================================================
       EVENTO GLOBAL PARA OUTROS SCRIPTS
    ======================================================== */

    window.AVMarketImageSearch = {
    ...
    console.log(
        "AV Market — pesquisa por fotografia carregada."
    );
...
(() => {
    ...
    if (!imageSearchButton || !imageSearchInput) {
        console.warn(
            "AV MARKET: elementos da pesquisa por imagem não encontrados."
        );
        return;
    }
    ...
    imageSearchInput.addEventListener("change", async (event) => {
        ...
        imageSearchButton.classList.add(
            "searching-image"
        );
        ...
        try {
            ...
            /* =============================================
               GUARDAR A IMAGEM DA PESQUISA
               PARA O SISTEMA UTILIZAR
            ============================================= */
            ...
            /* =============================================
               EVENTO PERSONALIZADO
               OUTROS SISTEMAS DO MARKET PODEM ESCUTAR
            ============================================= */
            ...
            /* =============================================
               INDICA QUE A IMAGEM FOI ENVIADA
            ============================================= */
            ...
            console.log(
                "AV MARKET — imagem enviada para o Supabase:",
                imageUrl
            );
            ...
            alert(
                ...
                "A pesquisa por imagem será processada."
            );
            ...
            console.error(
                "AV MARKET — erro na pesquisa por imagem:",
                error
            );
            ...
            imageSearchButton.classList.remove(
                "searching-image"
            );
